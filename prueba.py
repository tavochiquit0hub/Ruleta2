...
balas_reales = 0
balas_falsas = 0
vidas_perdidas_jugador_1 = 0
vidas_perdidas_jugador_2 = 0
...
def mostrar_puntuajes():
    mensaje = (
        f"Total de vidas perdidas:\n"
        f"Jugador 1: {vidas_perdidas_jugador_1}\n"
        f"Jugador 2: {vidas_perdidas_jugador_2}"
    )
    messagebox.showinfo("Puntuajes", mensaje)
...
def disparar(objetivo, ventana_juego):
    ...
    global vidas_perdidas_jugador_1, vidas_perdidas_jugador_2
    ...
    if resultado == "real":
        ...
        if perdedor == "Jugador 1":
            vidas_perdidas_jugador_1 += 1
        else:
            vidas_perdidas_jugador_2 += 1
...
def iniciar_juego():
    ...
    btn_disparar_contrincante = tk.Button(ventana_juego, text="Disparar al Contrincante", command=lambda: disparar("contrincante", ventana_juego), fg="red", bg="black")
    btn_disparar_contrincante.pack(pady=5)
...
btn_puntuajes = tk.Button(ventana, text="Ver Puntuajes", command=mostrar_puntuajes, fg="red", bg="black")
